...
const SignUp = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={{ fontSize: 13 }}>Enter your details below to create your Repora account.</Text>
      ...
      <View style={{ position: 'relative', marginTop: 12, marginBottom: 30 }}>
      ...
      <Button text='Create Account' onPress={() => validate()} />
      ...
      <Text style={{ textAlign: 'center', marginTop: 20 }}>Already have an account?{" "}<Link href={'/login'} style={{ color: Colors.primary }}>Sign In</Link></Text>
    </View>
  )
}
